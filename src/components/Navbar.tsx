    ...
    <nav className="navbar">
      <div className="navbar-container">
        ...
        <ul className={`nav-menu${menuOpen ? ' open' : ''}`}>
          ...
          <li className="nav-item nav-actions-mobile">
            <a href="/login" className="nav-action-link" onClick={handleLinkClick}>Login</a>
            <a href="/signup" className="nav-action-link signup" onClick={handleLinkClick}>Sign Up</a>
          </li>
        </ul>
